        ...
        <div>
          <div className="detailTurnamen px-[80px] mb-[30px]">
            <div className="text-[24px] text-[#BEE702] underline">
              <p>Detail Tournament</p>
            </div>
            <div className="text-[20px] text-[#F5F5F5]">
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum
                earum excepturi beatae obcaecati atque accusamus corrupti ex
                deserunt corporis culpa!
              </p>
            </div>
          </div>
          ...
          <div className="date pl-[80px] mb-[30px]">
            <div className="text-[24px] text-[#BEE702] underline">
              <p>Start-End Date Registration</p>
            </div>
            <div className="text-[20px] text-[#F5F5F5]">
              <p>26 Jun - 12 Jul </p>
            </div>
          ...
          <div className="linkRegist pl-[80px] mb-[30px]">
            <div className="text-[24px] text-[#BEE702] underline">
              <p>Link Registration</p>
            </div>
            <div className="text-[20px] text-[#F5F5F5] underline">
              <a>Https://lorem/Ipsum</a>
            </div>
          </div>
        </div>
